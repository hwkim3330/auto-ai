...
from depth_anything_v3.app.modules.utils import get_logo_base64, get_scene_info
...
class UIComponents:
    ...
    def create_measure_section(
        ...
        """
        from depth_anything_v3.app.css_and_html import MEASURE_INSTRUCTIONS_HTML
    ...
    def create_header_section(self) -> gr.HTML:
        ...
        """
        from depth_anything_v3.app.css_and_html import get_header_html
    ...
    def create_description_section(self) -> gr.HTML:
        ...
        """
        from depth_anything_v3.app.css_and_html import get_description_html
    ...
    def create_acknowledgements_section(self) -> gr.HTML:
        ...
        """
        from depth_anything_v3.app.css_and_html import get_acknowledgements_html
